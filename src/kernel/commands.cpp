...
CommandReply Commands::notImplementedYetCallback(const CommandHandler::Arguments &arguments)
{
...
CommandReply Commands::malformedArgumentsCallback(const CommandHandler::Arguments &arguments,
...
CommandReply Commands::commandsList(const CommandHandler::Arguments &UNUSED(arguments))
{
    std::string asString;
...
CommandReply Commands::pingPong(const CommandHandler::Arguments &UNUSED(arguments))
{
    return CommandHandler::toInlineReplyString("PONG");
}

CommandReply Commands::version(const CommandHandler::Arguments &arguments)
{
    /**
