...
public:
    typedef std::function<CommandReply(const CommandHandler::Arguments&)> Callback;
...
private:
     ...
     */
    static CommandReply notImplementedYetCallback(const CommandHandler::Arguments &arguments);

    /**
     * Just print warning, about malformed arguments
     * Not enough arguments, extra arguments, e.t.c.
     */
    static CommandReply malformedArgumentsCallback(const CommandHandler::Arguments &arguments,
     ...
     */
    CommandReply commandsList(const CommandHandler::Arguments &arguments);
    CommandReply pingPong(const CommandHandler::Arguments &arguments);
    CommandReply version(const CommandHandler::Arguments &arguments);
